            ...
            <CardBody className="p-1 sm:p-8">
              <div className="flex sm:items-center justify-between flex-col md:flex-row gap-3 ">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <p className="text-sm text-text-muted">{t('lastActive')}: {userInfo.lastActive}</p>
                </div>
              </div>
            </CardBody>
          </Card>
              ...
              <CardBody className="p-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-success">
                    {growth.groupsGrowth > 0 ? `+${growth.groupsGrowth}%` : '0%'}
                  </span>
                  <span className="text-xs text-text-muted">{t('fromLastMonth')}</span>
                </div>
              </CardBody>
            </Card>
              ...
              <CardBody className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-secondary">{stats.lists}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-success" />
              ...
              <CardBody className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-accent">{stats.completedLists}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-success" />
                  <span className="text-sm font-medium text-success">
                    {stats.completedLists > 0 ? `${Math.round((stats.completedLists / stats.lists) * 100)}%` : '0%'}
                  </span>
                  <span className="text-xs text-text-muted">{t('completionPercentage')}</span>
                </div>
              </CardBody>
            </Card>
              ...
              <CardBody className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-warning">{stats.purchasedItems}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-success" />
                  ...
                  <span className="text-xs text-text-muted">{t('purchasePercentage')}</span>
                </div>
              </CardBody>
            </Card>
              ...
              <CardBody className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-success">{stats.remainingItems}</p>
                  </div>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                  <div className="bg-gradient-to-r from-success-400 to-success-600 h-2 rounded-full" style={{ width: `${stats.totalItems > 0 ? Math.round((stats.remainingItems / stats.totalItems) * 100) : 0}%` }}></div>
                </div>
                <p className="text-xs text-text-muted text-center">{t('remainingToBuy')}</p>
              </CardBody>
            </Card>
                  ...
                  <>
                    ...
                    {stats.lists > 0 && (
                      <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-success-50/50 to-success-100/30 rounded-xl">
                        ...
                        <div className="text-right">
                          <span className="text-sm text-text-muted">{stats.completedLists} {t('completed')}</span>
                        </div>
                      </div>
                    )}
