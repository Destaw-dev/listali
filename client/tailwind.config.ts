...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Single source of truth: color values come from CSS variables in globals.css
      ...
      fontFamily: {
        sans: ['Inter', 'system-ui', 'Arial', 'Helvetica Neue', 'sans-serif'],
  ...
  plugins: [
    // We'll add plugins later if needed
  ],
}
